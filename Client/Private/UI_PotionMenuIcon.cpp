#include "stdafx.h"
#include "..\Public\UI_PotionMenuIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_PotionMenuIcon::m_iNextInstanceId = 0;

CUI_PotionMenuIcon::CUI_PotionMenuIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PotionMenuIcon::CUI_PotionMenuIcon(const CUI_PotionMenuIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PotionMenuIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PotionMenuIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PotionMenuIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PotionMenuIcon::Update(_float fTimeDelta)
{
...
void CUI_PotionMenuIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PotionMenuIcon::Render()
{
...
void CUI_PotionMenuIcon::Render_Text()
{
...
void CUI_PotionMenuIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PotionMenuIcon::MouseClick()
{
...
void CUI_PotionMenuIcon::MouseOn()
{

}

void CUI_PotionMenuIcon::MouseOut()
{
...
void CUI_PotionMenuIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_PotionMenuIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PotionMenuIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PotionMenuIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PotionMenuIcon* CUI_PotionMenuIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PotionMenuIcon* pInstance = new CUI_PotionMenuIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PotionMenuIcon"));
...
CGameObject* CUI_PotionMenuIcon::Clone(void* pArg)
{
	CUI_PotionMenuIcon* pInstance = new CUI_PotionMenuIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PotionMenuIcon"));
		Safe_Release(pInstance);
	}
