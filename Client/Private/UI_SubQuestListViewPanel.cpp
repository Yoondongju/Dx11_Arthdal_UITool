#include "stdafx.h"
#include "..\Public\UI_SubQuestListViewPanel.h"
...
CUI_SubQuestListViewPanel::CUI_SubQuestListViewPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SubQuestListViewPanel::CUI_SubQuestListViewPanel(const CUI_SubQuestListViewPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SubQuestListViewPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SubQuestListViewPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SubQuestListViewPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SubQuestListViewPanel::Update(_float fTimeDelta)
{
...
void CUI_SubQuestListViewPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SubQuestListViewPanel::Render()
{
...
void CUI_SubQuestListViewPanel::Render_Text()
{
...
void CUI_SubQuestListViewPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SubQuestListViewPanel::MouseClick()
{
...
void CUI_SubQuestListViewPanel::MouseOn()
{

}

void CUI_SubQuestListViewPanel::MouseOut()
{
...
void CUI_SubQuestListViewPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SubQuestListViewPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SubQuestListViewPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SubQuestListViewPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SubQuestListViewPanel* CUI_SubQuestListViewPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SubQuestListViewPanel* pInstance = new CUI_SubQuestListViewPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SubQuestListViewPanel"));
...
CGameObject* CUI_SubQuestListViewPanel::Clone(void* pArg)
{
	CUI_SubQuestListViewPanel* pInstance = new CUI_SubQuestListViewPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SubQuestListViewPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_SubQuestListViewPanel::Free()
{
	__super::Free();
