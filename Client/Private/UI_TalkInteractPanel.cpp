#include "stdafx.h"
#include "..\Public\UI_TalkInteractPanel.h"
...
CUI_TalkInteractPanel::CUI_TalkInteractPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_TalkInteractPanel::CUI_TalkInteractPanel(const CUI_TalkInteractPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_TalkInteractPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_TalkInteractPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_TalkInteractPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_TalkInteractPanel::Update(_float fTimeDelta)
{
...
void CUI_TalkInteractPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_TalkInteractPanel::Render()
{
...
void CUI_TalkInteractPanel::Render_Text()
{
...
void CUI_TalkInteractPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_TalkInteractPanel::MouseClick()
{
...
void CUI_TalkInteractPanel::MouseOn()
{

}

void CUI_TalkInteractPanel::MouseOut()
{
...
void CUI_TalkInteractPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_TalkInteractPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_TalkInteractPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_TalkInteractPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_TalkInteractPanel* CUI_TalkInteractPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_TalkInteractPanel* pInstance = new CUI_TalkInteractPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_TalkInteractPanel"));
...
CGameObject* CUI_TalkInteractPanel::Clone(void* pArg)
{
	CUI_TalkInteractPanel* pInstance = new CUI_TalkInteractPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_TalkInteractPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_TalkInteractPanel::Free()
{
	__super::Free();
