#include "stdafx.h"
#include "..\Public\UI_DuacaEatNotifyPanel.h"
...
CUI_DuacaEatNotifyPanel::CUI_DuacaEatNotifyPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_DuacaEatNotifyPanel::CUI_DuacaEatNotifyPanel(const CUI_DuacaEatNotifyPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_DuacaEatNotifyPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_DuacaEatNotifyPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_DuacaEatNotifyPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_DuacaEatNotifyPanel::Update(_float fTimeDelta)
{
...
void CUI_DuacaEatNotifyPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_DuacaEatNotifyPanel::Render()
{
...
void CUI_DuacaEatNotifyPanel::Render_Text()
{
...
void CUI_DuacaEatNotifyPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_DuacaEatNotifyPanel::MouseClick()
{
...
void CUI_DuacaEatNotifyPanel::MouseOn()
{

}

void CUI_DuacaEatNotifyPanel::MouseOut()
{
...
void CUI_DuacaEatNotifyPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_DuacaEatNotifyPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_DuacaEatNotifyPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_DuacaEatNotifyPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_DuacaEatNotifyPanel* CUI_DuacaEatNotifyPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_DuacaEatNotifyPanel* pInstance = new CUI_DuacaEatNotifyPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_DuacaEatNotifyPanel"));
...
CGameObject* CUI_DuacaEatNotifyPanel::Clone(void* pArg)
{
	CUI_DuacaEatNotifyPanel* pInstance = new CUI_DuacaEatNotifyPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_DuacaEatNotifyPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_DuacaEatNotifyPanel::Free()
{
	__super::Free();
