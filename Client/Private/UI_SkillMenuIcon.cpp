#include "stdafx.h"
#include "..\Public\UI_SkillMenuIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_SkillMenuIcon::m_iNextInstanceId = 0;

CUI_SkillMenuIcon::CUI_SkillMenuIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SkillMenuIcon::CUI_SkillMenuIcon(const CUI_SkillMenuIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SkillMenuIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SkillMenuIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SkillMenuIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SkillMenuIcon::Update(_float fTimeDelta)
{
...
void CUI_SkillMenuIcon::Late_Update(_float fTimeDelta)
{
...
void CUI_SkillMenuIcon::Render_Text()
{
...
void CUI_SkillMenuIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SkillMenuIcon::MouseClick()
{
...
void CUI_SkillMenuIcon::MouseOn()
{

}

void CUI_SkillMenuIcon::MouseOut()
{
...
void CUI_SkillMenuIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_SkillMenuIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SkillMenuIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SkillMenuIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SkillMenuIcon* CUI_SkillMenuIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SkillMenuIcon* pInstance = new CUI_SkillMenuIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SkillMenuIcon"));
...
CGameObject* CUI_SkillMenuIcon::Clone(void* pArg)
{
	CUI_SkillMenuIcon* pInstance = new CUI_SkillMenuIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SkillMenuIcon"));
		Safe_Release(pInstance);
	}
