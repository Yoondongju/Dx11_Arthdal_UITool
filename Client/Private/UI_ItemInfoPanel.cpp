#include "stdafx.h"
#include "..\Public\UI_ItemInfoPanel.h"
...
CUI_ItemInfoPanel::CUI_ItemInfoPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_ItemInfoPanel::CUI_ItemInfoPanel(const CUI_ItemInfoPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_ItemInfoPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_ItemInfoPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_ItemInfoPanel::Priority_Update(_float fTimeDelta)
{
...
void CUI_ItemInfoPanel::Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
void CUI_ItemInfoPanel::Late_Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
HRESULT CUI_ItemInfoPanel::Render()
{
...
void CUI_ItemInfoPanel::Render_Text()
{

}


void CUI_ItemInfoPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_ItemInfoPanel::MouseClick()
{
...
void CUI_ItemInfoPanel::MouseOn()
{

}

void CUI_ItemInfoPanel::MouseOut()
{
...
void CUI_ItemInfoPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_ItemInfoPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_ItemInfoPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_ItemInfoPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_ItemInfoPanel* CUI_ItemInfoPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_ItemInfoPanel* pInstance = new CUI_ItemInfoPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_ItemInfoPanel"));
...
CGameObject* CUI_ItemInfoPanel::Clone(void* pArg)
{
	CUI_ItemInfoPanel* pInstance = new CUI_ItemInfoPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_ItemInfoPanel"));
		Safe_Release(pInstance);
	}
