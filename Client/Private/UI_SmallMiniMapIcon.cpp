#include "stdafx.h"
#include "..\Public\UI_SmallMiniMapIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_SmallMiniMapIcon::m_iNextInstanceId = 0;

CUI_SmallMiniMapIcon::CUI_SmallMiniMapIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SmallMiniMapIcon::CUI_SmallMiniMapIcon(const CUI_SmallMiniMapIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SmallMiniMapIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SmallMiniMapIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SmallMiniMapIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SmallMiniMapIcon::Update(_float fTimeDelta)
{
...
void CUI_SmallMiniMapIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SmallMiniMapIcon::Render()
{
...
void CUI_SmallMiniMapIcon::Render_Text()
{
...
void CUI_SmallMiniMapIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SmallMiniMapIcon::MouseClick()
{
...
void CUI_SmallMiniMapIcon::MouseOn()
{

}

void CUI_SmallMiniMapIcon::MouseOut()
{
...
void CUI_SmallMiniMapIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_SmallMiniMapIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SmallMiniMapIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SmallMiniMapIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SmallMiniMapIcon* CUI_SmallMiniMapIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SmallMiniMapIcon* pInstance = new CUI_SmallMiniMapIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SmallMiniMapIcon"));
...
CGameObject* CUI_SmallMiniMapIcon::Clone(void* pArg)
{
	CUI_SmallMiniMapIcon* pInstance = new CUI_SmallMiniMapIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SmallMiniMapIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_SmallMiniMapIcon::Free()
{
	__super::Free();
