#include "stdafx.h"
#include "..\Public\UI_QuestSuccessPanel.h"
...
CUI_QuestSuccessPanel::CUI_QuestSuccessPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestSuccessPanel::CUI_QuestSuccessPanel(const CUI_QuestSuccessPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuestSuccessPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuestSuccessPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuestSuccessPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestSuccessPanel::Update(_float fTimeDelta)
{
...
void CUI_QuestSuccessPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuestSuccessPanel::Render()
{
...
void CUI_QuestSuccessPanel::Render_Text()
{
...
void CUI_QuestSuccessPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestSuccessPanel::MouseClick()
{
...
void CUI_QuestSuccessPanel::MouseOn()
{

}

void CUI_QuestSuccessPanel::MouseOut()
{
...
void CUI_QuestSuccessPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestSuccessPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestSuccessPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestSuccessPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestSuccessPanel* CUI_QuestSuccessPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestSuccessPanel* pInstance = new CUI_QuestSuccessPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestSuccessPanel"));
...
CGameObject* CUI_QuestSuccessPanel::Clone(void* pArg)
{
	CUI_QuestSuccessPanel* pInstance = new CUI_QuestSuccessPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestSuccessPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_QuestSuccessPanel::Free()
{
	__super::Free();
