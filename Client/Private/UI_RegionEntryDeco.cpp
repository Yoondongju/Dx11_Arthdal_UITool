#include "stdafx.h"
#include "..\Public\UI_RegionEntryDeco.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_RegionEntryDeco::m_iNextInstanceId = 0;

CUI_RegionEntryDeco::CUI_RegionEntryDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RegionEntryDeco::CUI_RegionEntryDeco(const CUI_RegionEntryDeco& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RegionEntryDeco::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RegionEntryDeco::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RegionEntryDeco::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RegionEntryDeco::Update(_float fTimeDelta)
{
...
void CUI_RegionEntryDeco::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_RegionEntryDeco::Render()
{
...
void CUI_RegionEntryDeco::Render_Text()
{
...
void CUI_RegionEntryDeco::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RegionEntryDeco::MouseClick()
{
...
void CUI_RegionEntryDeco::MouseOn()
{

}

void CUI_RegionEntryDeco::MouseOut()
{
...
void CUI_RegionEntryDeco::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_RegionEntryDeco::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RegionEntryDeco::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RegionEntryDeco::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RegionEntryDeco* CUI_RegionEntryDeco::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RegionEntryDeco* pInstance = new CUI_RegionEntryDeco(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RegionEntryDeco"));
...
CGameObject* CUI_RegionEntryDeco::Clone(void* pArg)
{
	CUI_RegionEntryDeco* pInstance = new CUI_RegionEntryDeco(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RegionEntryDeco"));
		Safe_Release(pInstance);
	}
