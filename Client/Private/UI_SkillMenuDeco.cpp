#include "stdafx.h"
#include "..\Public\UI_SkillMenuDeco.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_SkillMenuDeco::m_iNextInstanceId = 0;

CUI_SkillMenuDeco::CUI_SkillMenuDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SkillMenuDeco::CUI_SkillMenuDeco(const CUI_SkillMenuDeco& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SkillMenuDeco::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SkillMenuDeco::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SkillMenuDeco::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SkillMenuDeco::Update(_float fTimeDelta)
{
...
void CUI_SkillMenuDeco::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SkillMenuDeco::Render()
{
...
void CUI_SkillMenuDeco::Render_Text()
{
...
void CUI_SkillMenuDeco::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SkillMenuDeco::MouseClick()
{
...
void CUI_SkillMenuDeco::MouseOn()
{

}

void CUI_SkillMenuDeco::MouseOut()
{
...
void CUI_SkillMenuDeco::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_SkillMenuDeco::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SkillMenuDeco::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SkillMenuDeco::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SkillMenuDeco* CUI_SkillMenuDeco::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SkillMenuDeco* pInstance = new CUI_SkillMenuDeco(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SkillMenuDeco"));
...
CGameObject* CUI_SkillMenuDeco::Clone(void* pArg)
{
	CUI_SkillMenuDeco* pInstance = new CUI_SkillMenuDeco(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SkillMenuDeco"));
		Safe_Release(pInstance);
	}
