#include "stdafx.h"
#include "..\Public\UI_BigMiniMapPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_BigMiniMapPanel::m_iNextInstanceId = 0;

CUI_BigMiniMapPanel::CUI_BigMiniMapPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_BigMiniMapPanel::CUI_BigMiniMapPanel(const CUI_BigMiniMapPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_BigMiniMapPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_BigMiniMapPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_BigMiniMapPanel::Priority_Update(_float fTimeDelta)
{
...
void CUI_BigMiniMapPanel::Update(_float fTimeDelta)
{
...
void CUI_BigMiniMapPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_BigMiniMapPanel::Render()
{
...
void CUI_BigMiniMapPanel::Render_Text()
{
...
void CUI_BigMiniMapPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_BigMiniMapPanel::MouseClick()
{
...
void CUI_BigMiniMapPanel::MouseOn()
{

}

void CUI_BigMiniMapPanel::MouseOut()
{
...
void CUI_BigMiniMapPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_BigMiniMapPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_BigMiniMapPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_BigMiniMapPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_BigMiniMapPanel* CUI_BigMiniMapPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_BigMiniMapPanel* pInstance = new CUI_BigMiniMapPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_BigMiniMapPanel"));
...
CGameObject* CUI_BigMiniMapPanel::Clone(void* pArg)
{
	CUI_BigMiniMapPanel* pInstance = new CUI_BigMiniMapPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_BigMiniMapPanel"));
		Safe_Release(pInstance);
	}
