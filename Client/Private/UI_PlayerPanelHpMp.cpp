#include "stdafx.h"
#include "..\Public\UI_PlayerPanelHpMp.h"
...
CUI_PlayerPanelHpMp::CUI_PlayerPanelHpMp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PlayerPanelHpMp::CUI_PlayerPanelHpMp(const CUI_PlayerPanelHpMp& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PlayerPanelHpMp::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PlayerPanelHpMp::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PlayerPanelHpMp::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PlayerPanelHpMp::Update(_float fTimeDelta)
{
...
void CUI_PlayerPanelHpMp::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PlayerPanelHpMp::Render()
{
...
void CUI_PlayerPanelHpMp::Render_Text()
{
...
void CUI_PlayerPanelHpMp::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerPanelHpMp::MouseClick()
{
...
void CUI_PlayerPanelHpMp::MouseOn()
{

}

void CUI_PlayerPanelHpMp::MouseOut()
{
...
void CUI_PlayerPanelHpMp::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_PlayerPanelHpMp::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PlayerPanelHpMp::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerPanelHpMp::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PlayerPanelHpMp* CUI_PlayerPanelHpMp::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PlayerPanelHpMp* pInstance = new CUI_PlayerPanelHpMp(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PlayerPanelHpMp"));
...
CGameObject* CUI_PlayerPanelHpMp::Clone(void* pArg)
{
	CUI_PlayerPanelHpMp* pInstance = new CUI_PlayerPanelHpMp(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PlayerPanelHpMp"));
		Safe_Release(pInstance);
	}
