#include "stdafx.h"
#include "..\Public\UI_InventoryPanel.h"
...
CUI_InventoryPanel::CUI_InventoryPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_InventoryPanel::CUI_InventoryPanel(const CUI_InventoryPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_InventoryPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_InventoryPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_InventoryPanel::Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
void CUI_InventoryPanel::Late_Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
void CUI_InventoryPanel::Render_Text()
{
...
void CUI_InventoryPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_InventoryPanel::MouseClick()
{
...
void CUI_InventoryPanel::MouseOn()
{

}

void CUI_InventoryPanel::MouseOut()
{
...
void CUI_InventoryPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_InventoryPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_InventoryPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_InventoryPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_InventoryPanel* CUI_InventoryPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_InventoryPanel* pInstance = new CUI_InventoryPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_InventoryPanel"));
...
CGameObject* CUI_InventoryPanel::Clone(void* pArg)
{
	CUI_InventoryPanel* pInstance = new CUI_InventoryPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_InventoryPanel"));
		Safe_Release(pInstance);
	}
