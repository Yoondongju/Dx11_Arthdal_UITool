#include "stdafx.h"
#include "..\Public\UI_EquipPanel.h"
...
CUI_EquipPanel::CUI_EquipPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_EquipPanel::CUI_EquipPanel(const CUI_EquipPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_EquipPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_EquipPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_EquipPanel::Priority_Update(_float fTimeDelta)
{
...
void CUI_EquipPanel::Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
void CUI_EquipPanel::Late_Update(_float fTimeDelta)
{
	if (false == m_bActivate)
		return;
...
void CUI_EquipPanel::Render_Text()
{
	
}


void CUI_EquipPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_EquipPanel::MouseClick()
{
...
void CUI_EquipPanel::MouseOn()
{

}

void CUI_EquipPanel::MouseOut()
{
...
void CUI_EquipPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_EquipPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_EquipPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_EquipPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_EquipPanel* CUI_EquipPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_EquipPanel* pInstance = new CUI_EquipPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_EquipPanel"));
...
CGameObject* CUI_EquipPanel::Clone(void* pArg)
{
	CUI_EquipPanel* pInstance = new CUI_EquipPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_EquipPanel"));
		Safe_Release(pInstance);
	}
