#include "stdafx.h"
#include "..\Public\UI_QuickSlotHelperSecond.h"
...
CUI_QuickSlotHelperSecond::CUI_QuickSlotHelperSecond(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuickSlotHelperSecond::CUI_QuickSlotHelperSecond(const CUI_QuickSlotHelperSecond& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuickSlotHelperSecond::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuickSlotHelperSecond::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuickSlotHelperSecond::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuickSlotHelperSecond::Update(_float fTimeDelta)
{
...
void CUI_QuickSlotHelperSecond::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuickSlotHelperSecond::Render()
{
...
void CUI_QuickSlotHelperSecond::Render_Text()
{
...
void CUI_QuickSlotHelperSecond::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuickSlotHelperSecond::MouseClick()
{
...
void CUI_QuickSlotHelperSecond::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_QuickSlotHelperSecond::ExcuteMouseOn(_float fTimeDelta)
{
}

void CUI_QuickSlotHelperSecond::ExcuteMouseOut(_float fTimeDelta)
{
}


HRESULT CUI_QuickSlotHelperSecond::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuickSlotHelperSecond* CUI_QuickSlotHelperSecond::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuickSlotHelperSecond* pInstance = new CUI_QuickSlotHelperSecond(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuickSlotHelperSecond"));
...
CGameObject* CUI_QuickSlotHelperSecond::Clone(void* pArg)
{
	CUI_QuickSlotHelperSecond* pInstance = new CUI_QuickSlotHelperSecond(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuickSlotHelperSecond"));
		Safe_Release(pInstance);
	}
...
void CUI_QuickSlotHelperSecond::Free()
{
	__super::Free();
