#include "stdafx.h"
#include "..\Public\UI_PlayerDieIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_PlayerDieIcon::m_iNextInstanceId = 0;

CUI_PlayerDieIcon::CUI_PlayerDieIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PlayerDieIcon::CUI_PlayerDieIcon(const CUI_PlayerDieIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PlayerDieIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PlayerDieIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PlayerDieIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PlayerDieIcon::Update(_float fTimeDelta)
{
...
void CUI_PlayerDieIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PlayerDieIcon::Render()
{
...
void CUI_PlayerDieIcon::Render_Text()
{
...
void CUI_PlayerDieIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerDieIcon::MouseClick()
{
...
void CUI_PlayerDieIcon::MouseOn()
{

}

void CUI_PlayerDieIcon::MouseOut()
{
...
void CUI_PlayerDieIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_PlayerDieIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PlayerDieIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerDieIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PlayerDieIcon* CUI_PlayerDieIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PlayerDieIcon* pInstance = new CUI_PlayerDieIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PlayerDieIcon"));
...
CGameObject* CUI_PlayerDieIcon::Clone(void* pArg)
{
	CUI_PlayerDieIcon* pInstance = new CUI_PlayerDieIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PlayerDieIcon"));
		Safe_Release(pInstance);
	}
