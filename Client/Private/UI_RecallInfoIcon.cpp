#include "stdafx.h"
#include "..\Public\UI_RecallInfoIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_RecallInfoIcon::m_iNextInstanceId = 0;

CUI_RecallInfoIcon::CUI_RecallInfoIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RecallInfoIcon::CUI_RecallInfoIcon(const CUI_RecallInfoIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RecallInfoIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RecallInfoIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RecallInfoIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RecallInfoIcon::Update(_float fTimeDelta)
{
...
void CUI_RecallInfoIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_RecallInfoIcon::Render()
{
...
void CUI_RecallInfoIcon::Render_Text()
{
...
void CUI_RecallInfoIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RecallInfoIcon::MouseClick()
{
...
void CUI_RecallInfoIcon::MouseOn()
{

}

void CUI_RecallInfoIcon::MouseOut()
{
...
void CUI_RecallInfoIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_RecallInfoIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RecallInfoIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RecallInfoIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RecallInfoIcon* CUI_RecallInfoIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RecallInfoIcon* pInstance = new CUI_RecallInfoIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RecallInfoIcon"));
...
CGameObject* CUI_RecallInfoIcon::Clone(void* pArg)
{
	CUI_RecallInfoIcon* pInstance = new CUI_RecallInfoIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RecallInfoIcon"));
		Safe_Release(pInstance);
	}
