...
CUI_PlayerMp::CUI_PlayerMp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PlayerMp::CUI_PlayerMp(const CUI_PlayerMp& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PlayerMp::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PlayerMp::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PlayerMp::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PlayerMp::Update(_float fTimeDelta)
{	
...
void CUI_PlayerMp::Late_Update(_float fTimeDelta)
{
...
void CUI_PlayerMp::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerMp::MouseOn()
{

}

void CUI_PlayerMp::MouseOut()
{
...
void CUI_PlayerMp::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_PlayerMp::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PlayerMp::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerMp::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PlayerMp* CUI_PlayerMp::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PlayerMp* pInstance = new CUI_PlayerMp(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PlayerMp"));
...
CGameObject* CUI_PlayerMp::Clone(void* pArg)
{
	CUI_PlayerMp* pInstance = new CUI_PlayerMp(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PlayerMp"));
		Safe_Release(pInstance);
	}
