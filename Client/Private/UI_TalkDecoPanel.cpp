#include "stdafx.h"
#include "..\Public\UI_TalkDecoPanel.h"
...
CUI_TalkDecoPanel::CUI_TalkDecoPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_TalkDecoPanel::CUI_TalkDecoPanel(const CUI_TalkDecoPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_TalkDecoPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_TalkDecoPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_TalkDecoPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_TalkDecoPanel::Update(_float fTimeDelta)
{
...
void CUI_TalkDecoPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_TalkDecoPanel::Render()
{
...
void CUI_TalkDecoPanel::Render_Text()
{
...
void CUI_TalkDecoPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_TalkDecoPanel::MouseClick()
{
...
void CUI_TalkDecoPanel::MouseOn()
{

}

void CUI_TalkDecoPanel::MouseOut()
{
...
void CUI_TalkDecoPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_TalkDecoPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_TalkDecoPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_TalkDecoPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_TalkDecoPanel* CUI_TalkDecoPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_TalkDecoPanel* pInstance = new CUI_TalkDecoPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_TalkDecoPanel"));
...
CGameObject* CUI_TalkDecoPanel::Clone(void* pArg)
{
	CUI_TalkDecoPanel* pInstance = new CUI_TalkDecoPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_TalkDecoPanel"));
		Safe_Release(pInstance);
	}
