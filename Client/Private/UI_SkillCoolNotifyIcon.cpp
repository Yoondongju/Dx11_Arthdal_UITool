#include "stdafx.h"
#include "..\Public\UI_SkillCoolNotifyIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_SkillCoolNotifyIcon::m_iNextInstanceId = 0;

CUI_SkillCoolNotifyIcon::CUI_SkillCoolNotifyIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SkillCoolNotifyIcon::CUI_SkillCoolNotifyIcon(const CUI_SkillCoolNotifyIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SkillCoolNotifyIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SkillCoolNotifyIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SkillCoolNotifyIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SkillCoolNotifyIcon::Update(_float fTimeDelta)
{
...
void CUI_SkillCoolNotifyIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SkillCoolNotifyIcon::Render()
{
...
void CUI_SkillCoolNotifyIcon::Render_Text()
{
...
void CUI_SkillCoolNotifyIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SkillCoolNotifyIcon::MouseClick()
{
...
void CUI_SkillCoolNotifyIcon::MouseOn()
{

}

void CUI_SkillCoolNotifyIcon::MouseOut()
{
...
void CUI_SkillCoolNotifyIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SkillCoolNotifyIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SkillCoolNotifyIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SkillCoolNotifyIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SkillCoolNotifyIcon* CUI_SkillCoolNotifyIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SkillCoolNotifyIcon* pInstance = new CUI_SkillCoolNotifyIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SkillCoolNotifyIcon"));
...
CGameObject* CUI_SkillCoolNotifyIcon::Clone(void* pArg)
{
	CUI_SkillCoolNotifyIcon* pInstance = new CUI_SkillCoolNotifyIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SkillCoolNotifyIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_SkillCoolNotifyIcon::Free()
{
	__super::Free();
