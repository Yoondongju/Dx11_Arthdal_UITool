...
CUI_QuestIcon::CUI_QuestIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestIcon::CUI_QuestIcon(const CUI_QuestIcon& Prototype)
	: CUI{ Prototype }
{
}
...
void CUI_QuestIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestIcon::Update(_float fTimeDelta)
{
...
void CUI_QuestIcon::Late_Update(_float fTimeDelta)
{
...
void CUI_QuestIcon::Render_Text()
{
...
void CUI_QuestIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestIcon::MouseOn()
{

}

void CUI_QuestIcon::MouseOut()
{
...
void CUI_QuestIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestIcon* CUI_QuestIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestIcon* pInstance = new CUI_QuestIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestIcon"));
...
CGameObject* CUI_QuestIcon::Clone(void* pArg)
{
	...
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestIcon"));
		Safe_Release(pInstance);
	}
