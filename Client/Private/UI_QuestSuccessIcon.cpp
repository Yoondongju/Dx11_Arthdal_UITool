#include "stdafx.h"
#include "..\Public\UI_QuestSuccessIcon.h"
...
CUI_QuestSuccessIcon::CUI_QuestSuccessIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestSuccessIcon::CUI_QuestSuccessIcon(const CUI_QuestSuccessIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuestSuccessIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuestSuccessIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuestSuccessIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestSuccessIcon::Update(_float fTimeDelta)
{
...
void CUI_QuestSuccessIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuestSuccessIcon::Render()
{
...
void CUI_QuestSuccessIcon::Render_Text()
{
...
void CUI_QuestSuccessIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestSuccessIcon::MouseClick()
{
...
void CUI_QuestSuccessIcon::MouseOn()
{

}

void CUI_QuestSuccessIcon::MouseOut()
{
...
void CUI_QuestSuccessIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestSuccessIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestSuccessIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestSuccessIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestSuccessIcon* CUI_QuestSuccessIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestSuccessIcon* pInstance = new CUI_QuestSuccessIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestSuccessIcon"));
...
CGameObject* CUI_QuestSuccessIcon::Clone(void* pArg)
{
	CUI_QuestSuccessIcon* pInstance = new CUI_QuestSuccessIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestSuccessIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_QuestSuccessIcon::Free()
{
	__super::Free();
