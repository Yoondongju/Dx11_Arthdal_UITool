#include "stdafx.h"
#include "..\Public\UI_ItemInfoIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_ItemInfoIcon::m_iNextInstanceId = 0;

CUI_ItemInfoIcon::CUI_ItemInfoIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_ItemInfoIcon::CUI_ItemInfoIcon(const CUI_ItemInfoIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_ItemInfoIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_ItemInfoIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_ItemInfoIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_ItemInfoIcon::Update(_float fTimeDelta)
{
...
void CUI_ItemInfoIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_ItemInfoIcon::Render()
{
...
void CUI_ItemInfoIcon::Render_Text()
{
...
void CUI_ItemInfoIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_ItemInfoIcon::MouseClick()
{
...
void CUI_ItemInfoIcon::MouseOn()
{

}

void CUI_ItemInfoIcon::MouseOut()
{
...
void CUI_ItemInfoIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_ItemInfoIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_ItemInfoIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_ItemInfoIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_ItemInfoIcon* CUI_ItemInfoIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_ItemInfoIcon* pInstance = new CUI_ItemInfoIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_ItemInfoIcon"));
...
CGameObject* CUI_ItemInfoIcon::Clone(void* pArg)
{
	CUI_ItemInfoIcon* pInstance = new CUI_ItemInfoIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_ItemInfoIcon"));
		Safe_Release(pInstance);
	}
