#include "stdafx.h"
#include "..\Public\UI_FishingFailPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_FishingFailPanel::m_iNextInstanceId = 0;

CUI_FishingFailPanel::CUI_FishingFailPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_FishingFailPanel::CUI_FishingFailPanel(const CUI_FishingFailPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_FishingFailPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_FishingFailPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_FishingFailPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_FishingFailPanel::Update(_float fTimeDelta)
{
...
void CUI_FishingFailPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_FishingFailPanel::Render()
{
...
void CUI_FishingFailPanel::Render_Text()
{
...
void CUI_FishingFailPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_FishingFailPanel::MouseClick()
{
...
void CUI_FishingFailPanel::MouseOn()
{

}

void CUI_FishingFailPanel::MouseOut()
{
...
void CUI_FishingFailPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_FishingFailPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_FishingFailPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_FishingFailPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_FishingFailPanel* CUI_FishingFailPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_FishingFailPanel* pInstance = new CUI_FishingFailPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_FishingFailPanel"));
...
CGameObject* CUI_FishingFailPanel::Clone(void* pArg)
{
	CUI_FishingFailPanel* pInstance = new CUI_FishingFailPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_FishingFailPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_FishingFailPanel::Free()
{
	__super::Free();
