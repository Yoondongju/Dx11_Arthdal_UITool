#include "stdafx.h"
#include "..\Public\UI_RecallPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_RecallPanel::m_iNextInstanceId = 0;

CUI_RecallPanel::CUI_RecallPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RecallPanel::CUI_RecallPanel(const CUI_RecallPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RecallPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RecallPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RecallPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RecallPanel::Update(_float fTimeDelta)
{
...
void CUI_RecallPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_RecallPanel::Render()
{
...
void CUI_RecallPanel::Render_Text()
{
...
void CUI_RecallPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RecallPanel::MouseClick()
{
...
void CUI_RecallPanel::MouseOn()
{

}

void CUI_RecallPanel::MouseOut()
{
...
void CUI_RecallPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_RecallPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RecallPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RecallPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RecallPanel* CUI_RecallPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RecallPanel* pInstance = new CUI_RecallPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RecallPanel"));
...
CGameObject* CUI_RecallPanel::Clone(void* pArg)
{
	CUI_RecallPanel* pInstance = new CUI_RecallPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RecallPanel"));
		Safe_Release(pInstance);
	}
