#include "stdafx.h"
#include "..\Public\UI_EquipEnhancerPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_EquipEnhancerPanel::m_iNextInstanceId = 0;

CUI_EquipEnhancerPanel::CUI_EquipEnhancerPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_EquipEnhancerPanel::CUI_EquipEnhancerPanel(const CUI_EquipEnhancerPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_EquipEnhancerPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_EquipEnhancerPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_EquipEnhancerPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_EquipEnhancerPanel::Update(_float fTimeDelta)
{
...
void CUI_EquipEnhancerPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_EquipEnhancerPanel::Render()
{
...
void CUI_EquipEnhancerPanel::Render_Text()
{
...
void CUI_EquipEnhancerPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_EquipEnhancerPanel::MouseClick()
{
...
void CUI_EquipEnhancerPanel::MouseOn()
{

}

void CUI_EquipEnhancerPanel::MouseOut()
{
...
void CUI_EquipEnhancerPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_EquipEnhancerPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_EquipEnhancerPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_EquipEnhancerPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_EquipEnhancerPanel* CUI_EquipEnhancerPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_EquipEnhancerPanel* pInstance = new CUI_EquipEnhancerPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_EquipEnhancerPanel"));
...
CGameObject* CUI_EquipEnhancerPanel::Clone(void* pArg)
{
	CUI_EquipEnhancerPanel* pInstance = new CUI_EquipEnhancerPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_EquipEnhancerPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_EquipEnhancerPanel::Free()
{
	__super::Free();
