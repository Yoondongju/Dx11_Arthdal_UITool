#include "stdafx.h"
#include "..\Public\UI_FishingIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_FishingIcon::m_iNextInstanceId = 0;

CUI_FishingIcon::CUI_FishingIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_FishingIcon::CUI_FishingIcon(const CUI_FishingIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_FishingIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_FishingIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_FishingIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_FishingIcon::Update(_float fTimeDelta)
{
	...
	if (6 == m_iInstanceId || 7 == m_iInstanceId)
	{


		m_pTransformCom->Turn(XMVectorSet(0.f, 0.f, 1.f, 0.f), fTimeDelta * 3.f);
	}
...
void CUI_FishingIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_FishingIcon::Render()
{
...
void CUI_FishingIcon::Render_Text()
{
...
void CUI_FishingIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_FishingIcon::MouseClick()
{
...
void CUI_FishingIcon::MouseOn()
{

}

void CUI_FishingIcon::MouseOut()
{
...
void CUI_FishingIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_FishingIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_FishingIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_FishingIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_FishingIcon* CUI_FishingIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_FishingIcon* pInstance = new CUI_FishingIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_FishingIcon"));
...
CGameObject* CUI_FishingIcon::Clone(void* pArg)
{
	CUI_FishingIcon* pInstance = new CUI_FishingIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_FishingIcon"));
		Safe_Release(pInstance);
	}
