#include "stdafx.h"
#include "..\Public\UI_SkillCoolNotifyPanel.h"
...
CUI_SkillCoolNotifyPanel::CUI_SkillCoolNotifyPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SkillCoolNotifyPanel::CUI_SkillCoolNotifyPanel(const CUI_SkillCoolNotifyPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SkillCoolNotifyPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SkillCoolNotifyPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SkillCoolNotifyPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SkillCoolNotifyPanel::Update(_float fTimeDelta)
{
...
void CUI_SkillCoolNotifyPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SkillCoolNotifyPanel::Render()
{
...
void CUI_SkillCoolNotifyPanel::Render_Text()
{
...
void CUI_SkillCoolNotifyPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SkillCoolNotifyPanel::MouseClick()
{
...
void CUI_SkillCoolNotifyPanel::MouseOn()
{

}

void CUI_SkillCoolNotifyPanel::MouseOut()
{
...
void CUI_SkillCoolNotifyPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SkillCoolNotifyPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SkillCoolNotifyPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SkillCoolNotifyPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SkillCoolNotifyPanel* CUI_SkillCoolNotifyPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SkillCoolNotifyPanel* pInstance = new CUI_SkillCoolNotifyPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SkillCoolNotifyPanel"));
...
CGameObject* CUI_SkillCoolNotifyPanel::Clone(void* pArg)
{
	CUI_SkillCoolNotifyPanel* pInstance = new CUI_SkillCoolNotifyPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SkillCoolNotifyPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_SkillCoolNotifyPanel::Free()
{
	__super::Free();
