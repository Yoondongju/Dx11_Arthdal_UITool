#include "stdafx.h"
#include "..\Public\UI_FishingPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_FishingPanel::m_iNextInstanceId = 0;

CUI_FishingPanel::CUI_FishingPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_FishingPanel::CUI_FishingPanel(const CUI_FishingPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_FishingPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_FishingPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_FishingPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_FishingPanel::Update(_float fTimeDelta)
{
...
void CUI_FishingPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_FishingPanel::Render()
{
...
void CUI_FishingPanel::Render_Text()
{
...
void CUI_FishingPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_FishingPanel::MouseClick()
{
...
void CUI_FishingPanel::MouseOn()
{

}

void CUI_FishingPanel::MouseOut()
{
...
void CUI_FishingPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_FishingPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_FishingPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_FishingPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_FishingPanel* CUI_FishingPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_FishingPanel* pInstance = new CUI_FishingPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_FishingPanel"));
...
CGameObject* CUI_FishingPanel::Clone(void* pArg)
{
	CUI_FishingPanel* pInstance = new CUI_FishingPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_FishingPanel"));
		Safe_Release(pInstance);
	}
