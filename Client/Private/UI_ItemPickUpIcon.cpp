#include "stdafx.h"
#include "..\Public\UI_ItemPickUpIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_ItemPickUpIcon::m_iNextInstanceId = 0;

CUI_ItemPickUpIcon::CUI_ItemPickUpIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_ItemPickUpIcon::CUI_ItemPickUpIcon(const CUI_ItemPickUpIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_ItemPickUpIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_ItemPickUpIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_ItemPickUpIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_ItemPickUpIcon::Update(_float fTimeDelta)
{
...
void CUI_ItemPickUpIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_ItemPickUpIcon::Render()
{
...
void CUI_ItemPickUpIcon::Render_Text()
{
	...
	_float fFontPosX = m_fX - (m_fSizeX * 0.5f) + 40.f - (fTextWidth * 0.5f);
	_float fFontPosY = m_fY - 10;
	_float fScale = 0.3f;
	//
	//switch (m_iInstanceId)
	//{		
...
void CUI_ItemPickUpIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_ItemPickUpIcon::MouseClick()
{
...
void CUI_ItemPickUpIcon::MouseOn()
{

}

void CUI_ItemPickUpIcon::MouseOut()
{
...
void CUI_ItemPickUpIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_ItemPickUpIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_ItemPickUpIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_ItemPickUpIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_ItemPickUpIcon* CUI_ItemPickUpIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_ItemPickUpIcon* pInstance = new CUI_ItemPickUpIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_ItemPickUpIcon"));
...
CGameObject* CUI_ItemPickUpIcon::Clone(void* pArg)
{
	CUI_ItemPickUpIcon* pInstance = new CUI_ItemPickUpIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_ItemPickUpIcon"));
		Safe_Release(pInstance);
	}
