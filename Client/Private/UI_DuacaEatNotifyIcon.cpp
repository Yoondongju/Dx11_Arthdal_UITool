#include "stdafx.h"
#include "..\Public\UI_DuacaEatNotifyIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_DuacaEatNotifyIcon::m_iNextInstanceId = 0;

CUI_DuacaEatNotifyIcon::CUI_DuacaEatNotifyIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_DuacaEatNotifyIcon::CUI_DuacaEatNotifyIcon(const CUI_DuacaEatNotifyIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_DuacaEatNotifyIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_DuacaEatNotifyIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_DuacaEatNotifyIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_DuacaEatNotifyIcon::Update(_float fTimeDelta)
{
...
void CUI_DuacaEatNotifyIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_DuacaEatNotifyIcon::Render()
{
...
void CUI_DuacaEatNotifyIcon::Render_Text()
{
...
void CUI_DuacaEatNotifyIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_DuacaEatNotifyIcon::MouseClick()
{
...
void CUI_DuacaEatNotifyIcon::MouseOn()
{

}

void CUI_DuacaEatNotifyIcon::MouseOut()
{
...
void CUI_DuacaEatNotifyIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_DuacaEatNotifyIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_DuacaEatNotifyIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_DuacaEatNotifyIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_DuacaEatNotifyIcon* CUI_DuacaEatNotifyIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_DuacaEatNotifyIcon* pInstance = new CUI_DuacaEatNotifyIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_DuacaEatNotifyIcon"));
...
CGameObject* CUI_DuacaEatNotifyIcon::Clone(void* pArg)
{
	CUI_DuacaEatNotifyIcon* pInstance = new CUI_DuacaEatNotifyIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_DuacaEatNotifyIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_DuacaEatNotifyIcon::Free()
{
	__super::Free();
