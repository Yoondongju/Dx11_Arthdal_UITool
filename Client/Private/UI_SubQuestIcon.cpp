#include "stdafx.h"
#include "..\Public\UI_SubQuestIcon.h"
...
CUI_SubQuestIcon::CUI_SubQuestIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SubQuestIcon::CUI_SubQuestIcon(const CUI_SubQuestIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SubQuestIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SubQuestIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SubQuestIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SubQuestIcon::Update(_float fTimeDelta)
{
...
void CUI_SubQuestIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SubQuestIcon::Render()
{
...
void CUI_SubQuestIcon::Render_Text()
{
...
void CUI_SubQuestIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SubQuestIcon::MouseClick()
{
...
void CUI_SubQuestIcon::MouseOn()
{

}

void CUI_SubQuestIcon::MouseOut()
{
...
void CUI_SubQuestIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SubQuestIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SubQuestIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SubQuestIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SubQuestIcon* CUI_SubQuestIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SubQuestIcon* pInstance = new CUI_SubQuestIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SubQuestIcon"));
...
CGameObject* CUI_SubQuestIcon::Clone(void* pArg)
{
	CUI_SubQuestIcon* pInstance = new CUI_SubQuestIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SubQuestIcon"));
		Safe_Release(pInstance);
	}
