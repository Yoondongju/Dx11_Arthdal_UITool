#include "stdafx.h"
#include "..\Public\UI_KeyPadSkillIcon.h"
...
CUI_KeyPadSkillIcon::CUI_KeyPadSkillIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_KeyPadSkillIcon::CUI_KeyPadSkillIcon(const CUI_KeyPadSkillIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_KeyPadSkillIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_KeyPadSkillIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_KeyPadSkillIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_KeyPadSkillIcon::Update(_float fTimeDelta)
{
...
void CUI_KeyPadSkillIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_KeyPadSkillIcon::Render()
{
...
void CUI_KeyPadSkillIcon::Render_Text()
{
...
void CUI_KeyPadSkillIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_KeyPadSkillIcon::MouseClick()
{
...
void CUI_KeyPadSkillIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_KeyPadSkillIcon::ExcuteMouseOn(_float fTimeDelta)
{
}

void CUI_KeyPadSkillIcon::ExcuteMouseOut(_float fTimeDelta)
{
}


HRESULT CUI_KeyPadSkillIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_KeyPadSkillIcon* CUI_KeyPadSkillIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_KeyPadSkillIcon* pInstance = new CUI_KeyPadSkillIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_KeyPadSkillIcon"));
...
CGameObject* CUI_KeyPadSkillIcon::Clone(void* pArg)
{
	CUI_KeyPadSkillIcon* pInstance = new CUI_KeyPadSkillIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_KeyPadSkillIcon"));
		Safe_Release(pInstance);
	}
