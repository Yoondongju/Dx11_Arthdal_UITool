...
_uint CUI_Icon::m_iNextInstanceId = 0;
...
CUI_Icon::CUI_Icon(const CUI_Icon& Prototype)
	: CUI{ Prototype }
{
}
...
void CUI_Icon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_Icon::Update(_float fTimeDelta)
{
...
void CUI_Icon::Late_Update(_float fTimeDelta)
{
...
void CUI_Icon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_Icon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_Icon::ExcuteMouseOn(_float fTimeDelta)
{
	m_fSizeX = 1.5 * m_fOriginSizeX;
	m_fSizeY = 1.5 * m_fOriginSizeY;
}

void CUI_Icon::ExcuteMouseOut(_float fTimeDelta)
{
...
HRESULT CUI_Icon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_Icon* CUI_Icon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	...
	{
		MSG_BOX(TEXT("Failed to Created : CUI_Icon"));
...
CGameObject* CUI_Icon::Clone(void* pArg)
{
	...
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_Icon"));
		Safe_Release(pInstance);
	}
