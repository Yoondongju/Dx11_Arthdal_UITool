#include "stdafx.h"
#include "..\Public\UI_SubQuestPanel.h"
...
CUI_SubQuestPanel::CUI_SubQuestPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SubQuestPanel::CUI_SubQuestPanel(const CUI_SubQuestPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SubQuestPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SubQuestPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SubQuestPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SubQuestPanel::Update(_float fTimeDelta)
{
...
void CUI_SubQuestPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SubQuestPanel::Render()
{
...
void CUI_SubQuestPanel::Render_Text()
{
...
void CUI_SubQuestPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SubQuestPanel::MouseClick()
{
...
void CUI_SubQuestPanel::MouseOn()
{

}

void CUI_SubQuestPanel::MouseOut()
{
...
void CUI_SubQuestPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SubQuestPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SubQuestPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SubQuestPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SubQuestPanel* CUI_SubQuestPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SubQuestPanel* pInstance = new CUI_SubQuestPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SubQuestPanel"));
...
CGameObject* CUI_SubQuestPanel::Clone(void* pArg)
{
	CUI_SubQuestPanel* pInstance = new CUI_SubQuestPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SubQuestPanel"));
		Safe_Release(pInstance);
	}
