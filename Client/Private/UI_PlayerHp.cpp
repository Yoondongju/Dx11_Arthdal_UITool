...
void CUI_PlayerHp::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerHp::MouseOn()
{
	
}

void CUI_PlayerHp::MouseOut()
{
...
void CUI_PlayerHp::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_PlayerHp::ExcuteMouseOn(_float fTimeDelta)
{
	
}

void CUI_PlayerHp::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerHp::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
