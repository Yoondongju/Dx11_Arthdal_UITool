#include "stdafx.h"
#include "..\Public\UI_FishingFailIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_FishingFailIcon::m_iNextInstanceId = 0;

CUI_FishingFailIcon::CUI_FishingFailIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_FishingFailIcon::CUI_FishingFailIcon(const CUI_FishingFailIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_FishingFailIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_FishingFailIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_FishingFailIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_FishingFailIcon::Update(_float fTimeDelta)
{
...
void CUI_FishingFailIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_FishingFailIcon::Render()
{
...
void CUI_FishingFailIcon::Render_Text()
{
...
void CUI_FishingFailIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_FishingFailIcon::MouseClick()
{
...
void CUI_FishingFailIcon::MouseOn()
{

}

void CUI_FishingFailIcon::MouseOut()
{
...
void CUI_FishingFailIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_FishingFailIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_FishingFailIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_FishingFailIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_FishingFailIcon* CUI_FishingFailIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_FishingFailIcon* pInstance = new CUI_FishingFailIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_FishingFailIcon"));
...
CGameObject* CUI_FishingFailIcon::Clone(void* pArg)
{
	CUI_FishingFailIcon* pInstance = new CUI_FishingFailIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_FishingFailIcon"));
		Safe_Release(pInstance);
	}
