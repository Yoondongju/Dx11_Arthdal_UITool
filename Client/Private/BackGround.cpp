...
void CBackGround::Late_Update(_float fTimeDelta)
{
	...
	if (false == m_isCompleteBatch || nullptr == m_pParentUI)
	{
...
void CBackGround::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CBackGround::MouseClick()
{
	if (m_pGameInstance->Get_KeyState(KEY::ALT) == KEY_STATE::HOLD)
	{
		CLevel_MapTool::Set_PickedUI(this);	 // UI이상한게 바뀌는거같지? 이거 ImGui랑 겹쳐져있을때 겹쳐서 이런 이슈생기는거임
	}
