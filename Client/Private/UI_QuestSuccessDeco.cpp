#include "stdafx.h"
#include "..\Public\UI_QuestSuccessDeco.h"
...
CUI_QuestSuccessDeco::CUI_QuestSuccessDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestSuccessDeco::CUI_QuestSuccessDeco(const CUI_QuestSuccessDeco& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuestSuccessDeco::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuestSuccessDeco::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuestSuccessDeco::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestSuccessDeco::Update(_float fTimeDelta)
{
...
void CUI_QuestSuccessDeco::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuestSuccessDeco::Render()
{
...
void CUI_QuestSuccessDeco::Render_Text()
{
...
void CUI_QuestSuccessDeco::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestSuccessDeco::MouseClick()
{
...
void CUI_QuestSuccessDeco::MouseOn()
{

}

void CUI_QuestSuccessDeco::MouseOut()
{
...
void CUI_QuestSuccessDeco::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestSuccessDeco::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestSuccessDeco::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestSuccessDeco::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestSuccessDeco* CUI_QuestSuccessDeco::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestSuccessDeco* pInstance = new CUI_QuestSuccessDeco(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestSuccessDeco"));
...
CGameObject* CUI_QuestSuccessDeco::Clone(void* pArg)
{
	CUI_QuestSuccessDeco* pInstance = new CUI_QuestSuccessDeco(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestSuccessDeco"));
		Safe_Release(pInstance);
	}
...
void CUI_QuestSuccessDeco::Free()
{
	__super::Free();
