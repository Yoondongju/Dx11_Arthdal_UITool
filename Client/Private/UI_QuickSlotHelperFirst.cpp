#include "stdafx.h"
#include "..\Public\UI_QuickSlotHelperFirst.h"
...
CUI_QuickSlotHelperFirst::CUI_QuickSlotHelperFirst(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuickSlotHelperFirst::CUI_QuickSlotHelperFirst(const CUI_QuickSlotHelperFirst& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuickSlotHelperFirst::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuickSlotHelperFirst::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuickSlotHelperFirst::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuickSlotHelperFirst::Update(_float fTimeDelta)
{
...
void CUI_QuickSlotHelperFirst::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuickSlotHelperFirst::Render()
{
...
void CUI_QuickSlotHelperFirst::Render_Text()
{
...
void CUI_QuickSlotHelperFirst::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuickSlotHelperFirst::MouseClick()
{
...
void CUI_QuickSlotHelperFirst::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_QuickSlotHelperFirst::ExcuteMouseOn(_float fTimeDelta)
{
}

void CUI_QuickSlotHelperFirst::ExcuteMouseOut(_float fTimeDelta)
{
}


HRESULT CUI_QuickSlotHelperFirst::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuickSlotHelperFirst* CUI_QuickSlotHelperFirst::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuickSlotHelperFirst* pInstance = new CUI_QuickSlotHelperFirst(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuickSlotHelperFirst"));
...
CGameObject* CUI_QuickSlotHelperFirst::Clone(void* pArg)
{
	CUI_QuickSlotHelperFirst* pInstance = new CUI_QuickSlotHelperFirst(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuickSlotHelperFirst"));
		Safe_Release(pInstance);
	}
...
void CUI_QuickSlotHelperFirst::Free()
{
	__super::Free();
