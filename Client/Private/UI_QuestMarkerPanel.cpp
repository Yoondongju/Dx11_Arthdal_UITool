#include "stdafx.h"
#include "..\Public\UI_QuestMarkerPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_QuestMarkerPanel::m_iNextInstanceId;

CUI_QuestMarkerPanel::CUI_QuestMarkerPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestMarkerPanel::CUI_QuestMarkerPanel(const CUI_QuestMarkerPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuestMarkerPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuestMarkerPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuestMarkerPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestMarkerPanel::Update(_float fTimeDelta)
{
...
void CUI_QuestMarkerPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_QuestMarkerPanel::Render()
{
...
void CUI_QuestMarkerPanel::Render_Text()
{
...
void CUI_QuestMarkerPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestMarkerPanel::MouseClick()
{
...
void CUI_QuestMarkerPanel::MouseOn()
{

}

void CUI_QuestMarkerPanel::MouseOut()
{
...
void CUI_QuestMarkerPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestMarkerPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestMarkerPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestMarkerPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestMarkerPanel* CUI_QuestMarkerPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestMarkerPanel* pInstance = new CUI_QuestMarkerPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestMarkerPanel"));
...
CGameObject* CUI_QuestMarkerPanel::Clone(void* pArg)
{
	CUI_QuestMarkerPanel* pInstance = new CUI_QuestMarkerPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestMarkerPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_QuestMarkerPanel::Free()
{
	__super::Free();
