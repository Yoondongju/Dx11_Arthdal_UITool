#include "stdafx.h"
#include "..\Public\UI_RecallInfoPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_RecallInfoPanel::m_iNextInstanceId = 0;

CUI_RecallInfoPanel::CUI_RecallInfoPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RecallInfoPanel::CUI_RecallInfoPanel(const CUI_RecallInfoPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RecallInfoPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RecallInfoPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RecallInfoPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RecallInfoPanel::Update(_float fTimeDelta)
{
...
void CUI_RecallInfoPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_RecallInfoPanel::Render()
{
...
void CUI_RecallInfoPanel::Render_Text()
{
...
void CUI_RecallInfoPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RecallInfoPanel::MouseClick()
{
...
void CUI_RecallInfoPanel::MouseOn()
{

}

void CUI_RecallInfoPanel::MouseOut()
{
...
void CUI_RecallInfoPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_RecallInfoPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RecallInfoPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RecallInfoPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RecallInfoPanel* CUI_RecallInfoPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RecallInfoPanel* pInstance = new CUI_RecallInfoPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RecallInfoPanel"));
...
CGameObject* CUI_RecallInfoPanel::Clone(void* pArg)
{
	CUI_RecallInfoPanel* pInstance = new CUI_RecallInfoPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RecallInfoPanel"));
		Safe_Release(pInstance);
	}
