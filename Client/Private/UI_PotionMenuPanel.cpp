#include "stdafx.h"
#include "..\Public\UI_PotionMenuPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_PotionMenuPanel::m_iNextInstanceId = 0;

CUI_PotionMenuPanel::CUI_PotionMenuPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PotionMenuPanel::CUI_PotionMenuPanel(const CUI_PotionMenuPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PotionMenuPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PotionMenuPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PotionMenuPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PotionMenuPanel::Update(_float fTimeDelta)
{
...
void CUI_PotionMenuPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PotionMenuPanel::Render()
{
...
void CUI_PotionMenuPanel::Render_Text()
{
...
void CUI_PotionMenuPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PotionMenuPanel::MouseClick()
{
...
void CUI_PotionMenuPanel::MouseOn()
{

}

void CUI_PotionMenuPanel::MouseOut()
{
...
void CUI_PotionMenuPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_PotionMenuPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PotionMenuPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PotionMenuPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PotionMenuPanel* CUI_PotionMenuPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PotionMenuPanel* pInstance = new CUI_PotionMenuPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PotionMenuPanel"));
...
CGameObject* CUI_PotionMenuPanel::Clone(void* pArg)
{
	CUI_PotionMenuPanel* pInstance = new CUI_PotionMenuPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PotionMenuPanel"));
		Safe_Release(pInstance);
	}
