#include "stdafx.h"
#include "..\Public\UI_SkillMenuPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_SkillMenuPanel::m_iNextInstanceId = 0;

CUI_SkillMenuPanel::CUI_SkillMenuPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SkillMenuPanel::CUI_SkillMenuPanel(const CUI_SkillMenuPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SkillMenuPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SkillMenuPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SkillMenuPanel::Update(_float fTimeDelta)
{
...
void CUI_SkillMenuPanel::Render_Text()
{
...
void CUI_SkillMenuPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SkillMenuPanel::MouseClick()
{
...
void CUI_SkillMenuPanel::MouseOn()
{

}

void CUI_SkillMenuPanel::MouseOut()
{
...
void CUI_SkillMenuPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_SkillMenuPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SkillMenuPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SkillMenuPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SkillMenuPanel* CUI_SkillMenuPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SkillMenuPanel* pInstance = new CUI_SkillMenuPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SkillMenuPanel"));
...
CGameObject* CUI_SkillMenuPanel::Clone(void* pArg)
{
	CUI_SkillMenuPanel* pInstance = new CUI_SkillMenuPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SkillMenuPanel"));
		Safe_Release(pInstance);
	}
