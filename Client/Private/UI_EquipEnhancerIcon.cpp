#include "stdafx.h"
#include "..\Public\UI_EquipEnhancerIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_EquipEnhancerIcon::m_iNextInstanceId = 0;

CUI_EquipEnhancerIcon::CUI_EquipEnhancerIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_EquipEnhancerIcon::CUI_EquipEnhancerIcon(const CUI_EquipEnhancerIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_EquipEnhancerIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_EquipEnhancerIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_EquipEnhancerIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_EquipEnhancerIcon::Update(_float fTimeDelta)
{
...
void CUI_EquipEnhancerIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_EquipEnhancerIcon::Render()
{
...
void CUI_EquipEnhancerIcon::Render_Text()
{
...
void CUI_EquipEnhancerIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_EquipEnhancerIcon::MouseClick()
{
...
void CUI_EquipEnhancerIcon::MouseOn()
{

}

void CUI_EquipEnhancerIcon::MouseOut()
{
...
void CUI_EquipEnhancerIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_EquipEnhancerIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_EquipEnhancerIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_EquipEnhancerIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_EquipEnhancerIcon* CUI_EquipEnhancerIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_EquipEnhancerIcon* pInstance = new CUI_EquipEnhancerIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_EquipEnhancerIcon"));
...
CGameObject* CUI_EquipEnhancerIcon::Clone(void* pArg)
{
	CUI_EquipEnhancerIcon* pInstance = new CUI_EquipEnhancerIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_EquipEnhancerIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_EquipEnhancerIcon::Free()
{
	__super::Free();
