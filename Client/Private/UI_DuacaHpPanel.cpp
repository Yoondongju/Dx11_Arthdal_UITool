#include "stdafx.h"
#include "..\Public\UI_DuacaHpPanel.h"
...
CUI_DuacaHpPanel::CUI_DuacaHpPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_DuacaHpPanel::CUI_DuacaHpPanel(const CUI_DuacaHpPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_DuacaHpPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_DuacaHpPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_DuacaHpPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_DuacaHpPanel::Update(_float fTimeDelta)
{
...
void CUI_DuacaHpPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_DuacaHpPanel::Render()
{
...
void CUI_DuacaHpPanel::Render_Text()
{
...
void CUI_DuacaHpPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_DuacaHpPanel::MouseClick()
{
...
void CUI_DuacaHpPanel::MouseOn()
{

}

void CUI_DuacaHpPanel::MouseOut()
{
...
void CUI_DuacaHpPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_DuacaHpPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_DuacaHpPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_DuacaHpPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_DuacaHpPanel* CUI_DuacaHpPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_DuacaHpPanel* pInstance = new CUI_DuacaHpPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_DuacaHpPanel"));
...
CGameObject* CUI_DuacaHpPanel::Clone(void* pArg)
{
	CUI_DuacaHpPanel* pInstance = new CUI_DuacaHpPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_DuacaHpPanel"));
		Safe_Release(pInstance);
	}
