#include "stdafx.h"
#include "..\Public\UI_TradeNotifiIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_TradeNotifiIcon::m_iNextInstanceId = 0;

CUI_TradeNotifiIcon::CUI_TradeNotifiIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_TradeNotifiIcon::CUI_TradeNotifiIcon(const CUI_TradeNotifiIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_TradeNotifiIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_TradeNotifiIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_TradeNotifiIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_TradeNotifiIcon::Update(_float fTimeDelta)
{
...
void CUI_TradeNotifiIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_TradeNotifiIcon::Render()
{
...
void CUI_TradeNotifiIcon::Render_Text()
{
...
void CUI_TradeNotifiIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_TradeNotifiIcon::MouseClick()
{
...
void CUI_TradeNotifiIcon::MouseOn()
{

}

void CUI_TradeNotifiIcon::MouseOut()
{
...
void CUI_TradeNotifiIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_TradeNotifiIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_TradeNotifiIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_TradeNotifiIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_TradeNotifiIcon* CUI_TradeNotifiIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_TradeNotifiIcon* pInstance = new CUI_TradeNotifiIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_TradeNotifiIcon"));
...
CGameObject* CUI_TradeNotifiIcon::Clone(void* pArg)
{
	CUI_TradeNotifiIcon* pInstance = new CUI_TradeNotifiIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_TradeNotifiIcon"));
		Safe_Release(pInstance);
	}
