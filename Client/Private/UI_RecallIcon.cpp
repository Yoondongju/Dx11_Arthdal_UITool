#include "stdafx.h"
#include "..\Public\UI_RecallIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_RecallIcon::m_iNextInstanceId = 0;

CUI_RecallIcon::CUI_RecallIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RecallIcon::CUI_RecallIcon(const CUI_RecallIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RecallIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RecallIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RecallIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RecallIcon::Update(_float fTimeDelta)
{
...
void CUI_RecallIcon::Late_Update(_float fTimeDelta)
{
...
void CUI_RecallIcon::Render_Text()
{
...
void CUI_RecallIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RecallIcon::MouseClick()
{
...
void CUI_RecallIcon::MouseOn()
{

}

void CUI_RecallIcon::MouseOut()
{
...
void CUI_RecallIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_RecallIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RecallIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RecallIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RecallIcon* CUI_RecallIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RecallIcon* pInstance = new CUI_RecallIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RecallIcon"));
...
CGameObject* CUI_RecallIcon::Clone(void* pArg)
{
	CUI_RecallIcon* pInstance = new CUI_RecallIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RecallIcon"));
		Safe_Release(pInstance);
	}
