#include "stdafx.h"
#include "..\Public\UI_InventoryStaticIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_InventoryStaticIcon::m_iNextInstanceId = 0;

CUI_InventoryStaticIcon::CUI_InventoryStaticIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_InventoryStaticIcon::CUI_InventoryStaticIcon(const CUI_InventoryStaticIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_InventoryStaticIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_InventoryStaticIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
	...
	case 2:
	{
		m_Font.strFontText = L"0";
		m_Font.vFontColor = { 1.f,1.f,0.f,1.f };
	}
	break;

	case 3:
	{
		m_Font.strFontText = L"100,000";
		m_Font.vFontColor = { 1.f,1.f,0.f,1.f };
	}
	break;
...
void CUI_InventoryStaticIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_InventoryStaticIcon::Update(_float fTimeDelta)
{
...
void CUI_InventoryStaticIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_InventoryStaticIcon::Render()
{
...
void CUI_InventoryStaticIcon::Render_Text()
{
...
void CUI_InventoryStaticIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_InventoryStaticIcon::MouseClick()
{
...
void CUI_InventoryStaticIcon::MouseOn()
{

}

void CUI_InventoryStaticIcon::MouseOut()
{
...
void CUI_InventoryStaticIcon::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_InventoryStaticIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_InventoryStaticIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_InventoryStaticIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_InventoryStaticIcon* CUI_InventoryStaticIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_InventoryStaticIcon* pInstance = new CUI_InventoryStaticIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_InventoryStaticIcon"));
...
CGameObject* CUI_InventoryStaticIcon::Clone(void* pArg)
{
	CUI_InventoryStaticIcon* pInstance = new CUI_InventoryStaticIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_InventoryStaticIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_InventoryStaticIcon::Free()
{
	__super::Free();
