#include "stdafx.h"
#include "..\Public\UI_TradeNotifiPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_TradeNotifiPanel::m_iNextInstanceId = 0;

CUI_TradeNotifiPanel::CUI_TradeNotifiPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_TradeNotifiPanel::CUI_TradeNotifiPanel(const CUI_TradeNotifiPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_TradeNotifiPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_TradeNotifiPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_TradeNotifiPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_TradeNotifiPanel::Update(_float fTimeDelta)
{
...
void CUI_TradeNotifiPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_TradeNotifiPanel::Render()
{
...
void CUI_TradeNotifiPanel::Render_Text()
{
...
void CUI_TradeNotifiPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_TradeNotifiPanel::MouseClick()
{
...
void CUI_TradeNotifiPanel::MouseOn()
{

}

void CUI_TradeNotifiPanel::MouseOut()
{
...
void CUI_TradeNotifiPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_TradeNotifiPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_TradeNotifiPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_TradeNotifiPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_TradeNotifiPanel* CUI_TradeNotifiPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_TradeNotifiPanel* pInstance = new CUI_TradeNotifiPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_TradeNotifiPanel"));
...
CGameObject* CUI_TradeNotifiPanel::Clone(void* pArg)
{
	CUI_TradeNotifiPanel* pInstance = new CUI_TradeNotifiPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_TradeNotifiPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_TradeNotifiPanel::Free()
{
	__super::Free();
