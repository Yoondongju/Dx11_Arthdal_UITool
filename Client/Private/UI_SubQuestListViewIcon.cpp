#include "stdafx.h"
#include "..\Public\UI_SubQuestListViewIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_SubQuestListViewIcon::m_iNextInstanceId;

CUI_SubQuestListViewIcon::CUI_SubQuestListViewIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SubQuestListViewIcon::CUI_SubQuestListViewIcon(const CUI_SubQuestListViewIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SubQuestListViewIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SubQuestListViewIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SubQuestListViewIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SubQuestListViewIcon::Update(_float fTimeDelta)
{
...
void CUI_SubQuestListViewIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SubQuestListViewIcon::Render()
{
...
void CUI_SubQuestListViewIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SubQuestListViewIcon::MouseClick()
{
...
void CUI_SubQuestListViewIcon::MouseOn()
{

}

void CUI_SubQuestListViewIcon::MouseOut()
{
...
void CUI_SubQuestListViewIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_SubQuestListViewIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SubQuestListViewIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SubQuestListViewIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SubQuestListViewIcon* CUI_SubQuestListViewIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SubQuestListViewIcon* pInstance = new CUI_SubQuestListViewIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SubQuestListViewIcon"));
...
CGameObject* CUI_SubQuestListViewIcon::Clone(void* pArg)
{
	CUI_SubQuestListViewIcon* pInstance = new CUI_SubQuestListViewIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SubQuestListViewIcon"));
		Safe_Release(pInstance);
	}
...
void CUI_SubQuestListViewIcon::Free()
{
	__super::Free();
