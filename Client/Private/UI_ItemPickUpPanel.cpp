#include "stdafx.h"
#include "..\Public\UI_ItemPickUpPanel.h"
...
CUI_ItemPickUpPanel::CUI_ItemPickUpPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_ItemPickUpPanel::CUI_ItemPickUpPanel(const CUI_ItemPickUpPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_ItemPickUpPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_ItemPickUpPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
	...
	m_Font.strFontText = L"아이템";
	m_Font.vFontColor = _float4(1.f, 1.f, 1.f, 1.f);

	return S_OK;
}

void CUI_ItemPickUpPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_ItemPickUpPanel::Update(_float fTimeDelta)
{
...
void CUI_ItemPickUpPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_ItemPickUpPanel::Render()
{
...
void CUI_ItemPickUpPanel::Render_Text()
{
	_float fFontPosX = m_fX - (m_fSizeX * 0.5f) + 50.f;
	_float fFontPosY = m_fY - (m_fSizeY * 0.5f) + 3.f;
...
void CUI_ItemPickUpPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_ItemPickUpPanel::MouseClick()
{
...
void CUI_ItemPickUpPanel::MouseOn()
{

}

void CUI_ItemPickUpPanel::MouseOut()
{
...
void CUI_ItemPickUpPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_ItemPickUpPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_ItemPickUpPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_ItemPickUpPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_ItemPickUpPanel* CUI_ItemPickUpPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_ItemPickUpPanel* pInstance = new CUI_ItemPickUpPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_ItemPickUpPanel"));
...
CGameObject* CUI_ItemPickUpPanel::Clone(void* pArg)
{
	CUI_ItemPickUpPanel* pInstance = new CUI_ItemPickUpPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_ItemPickUpPanel"));
		Safe_Release(pInstance);
	}
