#include "stdafx.h"
#include "..\Public\UI_DuacaHpIcon.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint		 CUI_DuacaHpIcon::m_iNextInstanceId = 0;

CUI_DuacaHpIcon::CUI_DuacaHpIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_DuacaHpIcon::CUI_DuacaHpIcon(const CUI_DuacaHpIcon& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_DuacaHpIcon::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_DuacaHpIcon::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_DuacaHpIcon::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_DuacaHpIcon::Update(_float fTimeDelta)
{
...
void CUI_DuacaHpIcon::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_DuacaHpIcon::Render()
{
...
void CUI_DuacaHpIcon::Render_Text()
{
...
void CUI_DuacaHpIcon::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_DuacaHpIcon::MouseClick()
{
...
void CUI_DuacaHpIcon::MouseOn()
{

}

void CUI_DuacaHpIcon::MouseOut()
{
...
void CUI_DuacaHpIcon::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_DuacaHpIcon::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_DuacaHpIcon::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_DuacaHpIcon::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_DuacaHpIcon* CUI_DuacaHpIcon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_DuacaHpIcon* pInstance = new CUI_DuacaHpIcon(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_DuacaHpIcon"));
...
CGameObject* CUI_DuacaHpIcon::Clone(void* pArg)
{
	CUI_DuacaHpIcon* pInstance = new CUI_DuacaHpIcon(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_DuacaHpIcon"));
		Safe_Release(pInstance);
	}
