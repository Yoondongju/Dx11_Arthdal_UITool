#include "stdafx.h"
#include "..\Public\UI_SmallMiniMapPanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_SmallMiniMapPanel::m_iNextInstanceId = 0;

CUI_SmallMiniMapPanel::CUI_SmallMiniMapPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_SmallMiniMapPanel::CUI_SmallMiniMapPanel(const CUI_SmallMiniMapPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_SmallMiniMapPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_SmallMiniMapPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_SmallMiniMapPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_SmallMiniMapPanel::Update(_float fTimeDelta)
{
...
void CUI_SmallMiniMapPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_SmallMiniMapPanel::Render()
{
...
void CUI_SmallMiniMapPanel::Render_Text()
{
...
void CUI_SmallMiniMapPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_SmallMiniMapPanel::MouseClick()
{
...
void CUI_SmallMiniMapPanel::MouseOn()
{

}

void CUI_SmallMiniMapPanel::MouseOut()
{
...
void CUI_SmallMiniMapPanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_SmallMiniMapPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_SmallMiniMapPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_SmallMiniMapPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_SmallMiniMapPanel* CUI_SmallMiniMapPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_SmallMiniMapPanel* pInstance = new CUI_SmallMiniMapPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_SmallMiniMapPanel"));
...
CGameObject* CUI_SmallMiniMapPanel::Clone(void* pArg)
{
	CUI_SmallMiniMapPanel* pInstance = new CUI_SmallMiniMapPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_SmallMiniMapPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_SmallMiniMapPanel::Free()
{
	__super::Free();
