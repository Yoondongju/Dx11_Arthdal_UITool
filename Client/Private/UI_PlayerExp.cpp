...
CUI_PlayerExp::CUI_PlayerExp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PlayerExp::CUI_PlayerExp(const CUI_PlayerExp& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PlayerExp::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PlayerExp::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PlayerExp::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PlayerExp::Update(_float fTimeDelta)
{
...
void CUI_PlayerExp::Late_Update(_float fTimeDelta)
{
...
void CUI_PlayerExp::Render_Text()
{
...
void CUI_PlayerExp::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerExp::MouseOn()
{

}

void CUI_PlayerExp::MouseOut()
{
...
void CUI_PlayerExp::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_PlayerExp::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PlayerExp::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerExp::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PlayerExp* CUI_PlayerExp::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PlayerExp* pInstance = new CUI_PlayerExp(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PlayerExp"));
...
CGameObject* CUI_PlayerExp::Clone(void* pArg)
{
	CUI_PlayerExp* pInstance = new CUI_PlayerExp(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PlayerExp"));
		Safe_Release(pInstance);
	}
