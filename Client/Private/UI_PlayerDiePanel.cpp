#include "stdafx.h"
#include "..\Public\UI_PlayerDiePanel.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_PlayerDiePanel::m_iNextInstanceId = 0;

CUI_PlayerDiePanel::CUI_PlayerDiePanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PlayerDiePanel::CUI_PlayerDiePanel(const CUI_PlayerDiePanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PlayerDiePanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PlayerDiePanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PlayerDiePanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PlayerDiePanel::Update(_float fTimeDelta)
{
...
void CUI_PlayerDiePanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PlayerDiePanel::Render()
{
...
void CUI_PlayerDiePanel::Render_Text()
{
...
void CUI_PlayerDiePanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PlayerDiePanel::MouseClick()
{
...
void CUI_PlayerDiePanel::MouseOn()
{

}

void CUI_PlayerDiePanel::MouseOut()
{
...
void CUI_PlayerDiePanel::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_PlayerDiePanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PlayerDiePanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PlayerDiePanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PlayerDiePanel* CUI_PlayerDiePanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PlayerDiePanel* pInstance = new CUI_PlayerDiePanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PlayerDiePanel"));
...
CGameObject* CUI_PlayerDiePanel::Clone(void* pArg)
{
	CUI_PlayerDiePanel* pInstance = new CUI_PlayerDiePanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PlayerDiePanel"));
		Safe_Release(pInstance);
	}
