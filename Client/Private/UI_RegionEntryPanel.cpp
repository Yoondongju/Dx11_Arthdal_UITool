#include "stdafx.h"
#include "..\Public\UI_RegionEntryPanel.h"
...
CUI_RegionEntryPanel::CUI_RegionEntryPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_RegionEntryPanel::CUI_RegionEntryPanel(const CUI_RegionEntryPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_RegionEntryPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_RegionEntryPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_RegionEntryPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_RegionEntryPanel::Update(_float fTimeDelta)
{
...
void CUI_RegionEntryPanel::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_RegionEntryPanel::Render()
{
...
void CUI_RegionEntryPanel::Render_Text()
{
...
void CUI_RegionEntryPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_RegionEntryPanel::MouseClick()
{
...
void CUI_RegionEntryPanel::MouseOn()
{

}

void CUI_RegionEntryPanel::MouseOut()
{
...
void CUI_RegionEntryPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_RegionEntryPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_RegionEntryPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_RegionEntryPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_RegionEntryPanel* CUI_RegionEntryPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_RegionEntryPanel* pInstance = new CUI_RegionEntryPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_RegionEntryPanel"));
...
CGameObject* CUI_RegionEntryPanel::Clone(void* pArg)
{
	CUI_RegionEntryPanel* pInstance = new CUI_RegionEntryPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_RegionEntryPanel"));
		Safe_Release(pInstance);
	}
...
void CUI_RegionEntryPanel::Free()
{
	__super::Free();
