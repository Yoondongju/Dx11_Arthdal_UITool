#include "stdafx.h"
#include "..\Public\UI_PotionMenuDeco.h"

#include "GameInstance.h"

#include "Level_MapTool.h"

_uint CUI_PotionMenuDeco::m_iNextInstanceId = 0;

CUI_PotionMenuDeco::CUI_PotionMenuDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_PotionMenuDeco::CUI_PotionMenuDeco(const CUI_PotionMenuDeco& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_PotionMenuDeco::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_PotionMenuDeco::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_PotionMenuDeco::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_PotionMenuDeco::Update(_float fTimeDelta)
{
...
void CUI_PotionMenuDeco::Late_Update(_float fTimeDelta)
{
...
HRESULT CUI_PotionMenuDeco::Render()
{
...
void CUI_PotionMenuDeco::Render_Text()
{
...
void CUI_PotionMenuDeco::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_PotionMenuDeco::MouseClick()
{
...
void CUI_PotionMenuDeco::MouseOn()
{

}

void CUI_PotionMenuDeco::MouseOut()
{
...
void CUI_PotionMenuDeco::ExcuteMouseClick(_float fTimeDelta)
{
...
void CUI_PotionMenuDeco::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_PotionMenuDeco::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_PotionMenuDeco::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_PotionMenuDeco* CUI_PotionMenuDeco::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_PotionMenuDeco* pInstance = new CUI_PotionMenuDeco(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_PotionMenuDeco"));
...
CGameObject* CUI_PotionMenuDeco::Clone(void* pArg)
{
	CUI_PotionMenuDeco* pInstance = new CUI_PotionMenuDeco(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_PotionMenuDeco"));
		Safe_Release(pInstance);
	}
