...
_uint CUI_Menu::m_iNextInstanceId = 0;
...
void CUI_Menu::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_Menu::ExcuteMouseClick(_float fTimeDelta)
{	
}

void CUI_Menu::ExcuteMouseOn(_float fTimeDelta)
{
	m_fSizeX = 1.5 * m_fOriginSizeX;
	m_fSizeY = 1.5 * m_fOriginSizeY;
}

void CUI_Menu::ExcuteMouseOut(_float fTimeDelta)
{
...
HRESULT CUI_Menu::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
