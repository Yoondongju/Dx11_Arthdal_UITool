#include "stdafx.h"
#include "..\Public\UI_QuestPanel.h"
...
CUI_QuestPanel::CUI_QuestPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{

}

CUI_QuestPanel::CUI_QuestPanel(const CUI_QuestPanel& Prototype)
	: CUI{ Prototype }
{
}

HRESULT CUI_QuestPanel::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_QuestPanel::Initialize(void* pArg)
{
	if (nullptr == pArg)
	{
		UI_DESC			Desc{};
...
void CUI_QuestPanel::Priority_Update(_float fTimeDelta)
{
	for (auto pChildUI : m_childUI_List)
		pChildUI->Priority_Update(fTimeDelta);
}

void CUI_QuestPanel::Update(_float fTimeDelta)
{
...
void CUI_QuestPanel::Late_Update(_float fTimeDelta)
{
...
void CUI_QuestPanel::Render_Text()
{
...
void CUI_QuestPanel::ChangeTexture(const _wstring& LstrChangeTexturePrototype)
{
...
void CUI_QuestPanel::MouseClick()
{
...
void CUI_QuestPanel::MouseOn()
{

}

void CUI_QuestPanel::MouseOut()
{
...
void CUI_QuestPanel::ExcuteMouseClick(_float fTimeDelta)
{
}

void CUI_QuestPanel::ExcuteMouseOn(_float fTimeDelta)
{

}

void CUI_QuestPanel::ExcuteMouseOut(_float fTimeDelta)
{

}


HRESULT CUI_QuestPanel::Ready_Components(void* pArg)
{
	/* FOR.Com_Shader */
...
CUI_QuestPanel* CUI_QuestPanel::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CUI_QuestPanel* pInstance = new CUI_QuestPanel(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CUI_QuestPanel"));
...
CGameObject* CUI_QuestPanel::Clone(void* pArg)
{
	CUI_QuestPanel* pInstance = new CUI_QuestPanel(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed to Cloned : CUI_QuestPanel"));
		Safe_Release(pInstance);
	}
