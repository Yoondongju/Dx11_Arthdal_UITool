...
class CUI_MainMenuPanel final : public CUI
{
public:

private:
	CUI_MainMenuPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_MainMenuPanel(const CUI_MainMenuPanel& Prototype);
	virtual ~CUI_MainMenuPanel() = default;
...
public:
	static CUI_MainMenuPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
