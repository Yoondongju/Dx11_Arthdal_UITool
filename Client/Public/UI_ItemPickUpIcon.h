...
class CUI_ItemPickUpIcon final : public CUI
{
public:

private:
	CUI_ItemPickUpIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_ItemPickUpIcon(const CUI_ItemPickUpIcon& Prototype);
	virtual ~CUI_ItemPickUpIcon() = default;
...
public:
	static CUI_ItemPickUpIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
