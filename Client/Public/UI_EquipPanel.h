...
class CUI_EquipPanel final : public CUI
{
public:

private:
	CUI_EquipPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_EquipPanel(const CUI_EquipPanel& Prototype);
	virtual ~CUI_EquipPanel() = default;
...
public:
	static CUI_EquipPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
