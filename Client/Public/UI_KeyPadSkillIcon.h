...
class CUI_KeyPadSkillIcon final : public CUI
{
public:

private:
	CUI_KeyPadSkillIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_KeyPadSkillIcon(const CUI_KeyPadSkillIcon& Prototype);
	virtual ~CUI_KeyPadSkillIcon() = default;
...
public:
	static CUI_KeyPadSkillIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
