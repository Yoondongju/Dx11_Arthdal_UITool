...
class CUI_SkillCoolNotifyIcon final : public CUI
{
public:


private:
	CUI_SkillCoolNotifyIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SkillCoolNotifyIcon(const CUI_SkillCoolNotifyIcon& Prototype);
	virtual ~CUI_SkillCoolNotifyIcon() = default;
...
public:
	static CUI_SkillCoolNotifyIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
