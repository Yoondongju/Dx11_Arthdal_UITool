...
class CUI_PlayerHp final : public CUI
{
public:
...
private:
	...
	CUI_PlayerHp(const CUI_PlayerHp& Prototype);
	virtual ~CUI_PlayerHp() = default;
...
public:
	static CUI_PlayerHp* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
