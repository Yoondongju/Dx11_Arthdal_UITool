...
class CUI_SkillMenuDeco final : public CUI
{
public:

private:
	CUI_SkillMenuDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SkillMenuDeco(const CUI_SkillMenuDeco& Prototype);
	virtual ~CUI_SkillMenuDeco() = default;
...
public:
	static CUI_SkillMenuDeco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
