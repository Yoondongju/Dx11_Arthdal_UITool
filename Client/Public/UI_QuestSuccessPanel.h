#pragma once
class CUI_QuestSuccessPanelPanel
{
};
...
class CUI_QuestSuccessPanel final : public CUI
{
public:

private:
	CUI_QuestSuccessPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestSuccessPanel(const CUI_QuestSuccessPanel& Prototype);
	virtual ~CUI_QuestSuccessPanel() = default;
...
public:
	static CUI_QuestSuccessPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
