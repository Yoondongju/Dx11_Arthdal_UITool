...
class CUI_SmallMiniMapPanel final : public CUI
{
public:

private:
	CUI_SmallMiniMapPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SmallMiniMapPanel(const CUI_SmallMiniMapPanel& Prototype);
	virtual ~CUI_SmallMiniMapPanel() = default;
...
public:
	static CUI_SmallMiniMapPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
