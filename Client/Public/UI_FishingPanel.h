...
class CUI_FishingPanel final : public CUI
{
private:
    CUI_FishingPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_FishingPanel(const CUI_FishingPanel& Prototype);
    virtual ~CUI_FishingPanel() = default;
...
public:
    static CUI_FishingPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
