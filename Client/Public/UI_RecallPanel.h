...
class CUI_RecallPanel final : public CUI
{
public:

private:
	CUI_RecallPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_RecallPanel(const CUI_RecallPanel& Prototype);
	virtual ~CUI_RecallPanel() = default;
...
public:
	static CUI_RecallPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
