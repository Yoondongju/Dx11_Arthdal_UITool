#pragma once
class CUI_QuestMarkerPanelPanel
{
};
...
class CUI_QuestMarkerPanel final : public CUI
{
public:

private:
	CUI_QuestMarkerPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestMarkerPanel(const CUI_QuestMarkerPanel& Prototype);
	virtual ~CUI_QuestMarkerPanel() = default;
...
public:
	static CUI_QuestMarkerPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
