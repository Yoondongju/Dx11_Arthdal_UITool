...
class CUI_SubQuestIcon final : public CUI
{
public:

private:
	CUI_SubQuestIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SubQuestIcon(const CUI_SubQuestIcon& Prototype);
	virtual ~CUI_SubQuestIcon() = default;
...
public:
	static CUI_SubQuestIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
