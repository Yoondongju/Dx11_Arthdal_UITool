...
class CUI_SkillMenuPanel final : public CUI
{
public:

private:
	CUI_SkillMenuPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SkillMenuPanel(const CUI_SkillMenuPanel& Prototype);
	virtual ~CUI_SkillMenuPanel() = default;
...
public:
	static CUI_SkillMenuPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
