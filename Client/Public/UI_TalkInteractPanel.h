...
class CUI_TalkInteractPanel final : public CUI
{
public:


private:
	CUI_TalkInteractPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_TalkInteractPanel(const CUI_TalkInteractPanel& Prototype);
	virtual ~CUI_TalkInteractPanel() = default;
...
public:
	static CUI_TalkInteractPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
