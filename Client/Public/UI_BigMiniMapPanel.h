...
class CUI_BigMiniMapPanel final : public CUI
{
public:

private:
	CUI_BigMiniMapPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_BigMiniMapPanel(const CUI_BigMiniMapPanel& Prototype);
	virtual ~CUI_BigMiniMapPanel() = default;
...
public:
	static CUI_BigMiniMapPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
