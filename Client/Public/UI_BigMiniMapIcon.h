...
class CUI_BigMiniMapIcon final : public CUI
{
public:

private:
	CUI_BigMiniMapIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_BigMiniMapIcon(const CUI_BigMiniMapIcon& Prototype);
	virtual ~CUI_BigMiniMapIcon() = default;
...
public:
	static CUI_BigMiniMapIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
