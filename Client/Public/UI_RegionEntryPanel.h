...
class CUI_RegionEntryPanel final : public CUI
{
public:


private:
	CUI_RegionEntryPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_RegionEntryPanel(const CUI_RegionEntryPanel& Prototype);
	virtual ~CUI_RegionEntryPanel() = default;
...
public:
	static CUI_RegionEntryPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
