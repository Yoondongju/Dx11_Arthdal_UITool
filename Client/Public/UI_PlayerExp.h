...
class CUI_PlayerExp final : public CUI
{
public:


private:
	CUI_PlayerExp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_PlayerExp(const CUI_PlayerExp& Prototype);
	virtual ~CUI_PlayerExp() = default;
...
public:
	static CUI_PlayerExp* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
