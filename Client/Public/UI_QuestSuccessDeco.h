#pragma once
class CUI_QuestSuccessDecoPanel
{
};
...
class CUI_QuestSuccessDeco final : public CUI
{
public:

private:
	CUI_QuestSuccessDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestSuccessDeco(const CUI_QuestSuccessDeco& Prototype);
	virtual ~CUI_QuestSuccessDeco() = default;
...
public:
	static CUI_QuestSuccessDeco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
