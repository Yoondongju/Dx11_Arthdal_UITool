...
class CUI_PlayerMp final : public CUI
{
public:


private:
	CUI_PlayerMp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_PlayerMp(const CUI_PlayerMp& Prototype);
	virtual ~CUI_PlayerMp() = default;
...
public:
	static CUI_PlayerMp* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
