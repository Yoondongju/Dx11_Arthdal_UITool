...
class CUI_RecallInfoPanel final : public CUI
{
public:

private:
	CUI_RecallInfoPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_RecallInfoPanel(const CUI_RecallInfoPanel& Prototype);
	virtual ~CUI_RecallInfoPanel() = default;
...
public:
	static CUI_RecallInfoPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
