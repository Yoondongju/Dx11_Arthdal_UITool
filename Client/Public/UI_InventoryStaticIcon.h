...
class CUI_InventoryStaticIcon final : public CUI
{
public:

private:
	CUI_InventoryStaticIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_InventoryStaticIcon(const CUI_InventoryStaticIcon& Prototype);
	virtual ~CUI_InventoryStaticIcon() = default;
...
public:
	static CUI_InventoryStaticIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
