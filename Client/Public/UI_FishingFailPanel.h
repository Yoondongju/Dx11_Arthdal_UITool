...
class CUI_FishingFailPanel final : public CUI
{
private:
    CUI_FishingFailPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_FishingFailPanel(const CUI_FishingFailPanel& Prototype);
    virtual ~CUI_FishingFailPanel() = default;
...
public:
    static CUI_FishingFailPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
