...
class CUI_PlayerDieIcon final : public CUI
{
private:
    CUI_PlayerDieIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_PlayerDieIcon(const CUI_PlayerDieIcon& Prototype);
    virtual ~CUI_PlayerDieIcon() = default;
...
public:
    static CUI_PlayerDieIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
