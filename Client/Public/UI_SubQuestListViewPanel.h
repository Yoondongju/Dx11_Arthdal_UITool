...
class CUI_SubQuestListViewPanel final : public CUI
{
public:

private:
	CUI_SubQuestListViewPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SubQuestListViewPanel(const CUI_SubQuestListViewPanel& Prototype);
	virtual ~CUI_SubQuestListViewPanel() = default;
...
public:
	static CUI_SubQuestListViewPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
