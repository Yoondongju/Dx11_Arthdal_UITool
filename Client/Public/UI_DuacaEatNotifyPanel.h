...
class CUI_DuacaEatNotifyPanel final : public CUI
{
public:


private:
	CUI_DuacaEatNotifyPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_DuacaEatNotifyPanel(const CUI_DuacaEatNotifyPanel& Prototype);
	virtual ~CUI_DuacaEatNotifyPanel() = default;
...
public:
	static CUI_DuacaEatNotifyPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
