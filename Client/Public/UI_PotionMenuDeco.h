...
class CUI_PotionMenuDeco final : public CUI
{
public:

private:
	CUI_PotionMenuDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_PotionMenuDeco(const CUI_PotionMenuDeco& Prototype);
	virtual ~CUI_PotionMenuDeco() = default;
...
public:
	static CUI_PotionMenuDeco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
