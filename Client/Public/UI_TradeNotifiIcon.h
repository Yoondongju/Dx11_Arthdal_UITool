...
class CUI_TradeNotifiIcon final : public CUI
{
private:
    CUI_TradeNotifiIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_TradeNotifiIcon(const CUI_TradeNotifiIcon& Prototype);
    virtual ~CUI_TradeNotifiIcon() = default;
...
public:
    static CUI_TradeNotifiIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
