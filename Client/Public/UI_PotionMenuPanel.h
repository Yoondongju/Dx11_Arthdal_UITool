...
class CUI_PotionMenuPanel final : public CUI
{
private:
    CUI_PotionMenuPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_PotionMenuPanel(const CUI_PotionMenuPanel& Prototype);
    virtual ~CUI_PotionMenuPanel() = default;
...
public:
    static CUI_PotionMenuPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
