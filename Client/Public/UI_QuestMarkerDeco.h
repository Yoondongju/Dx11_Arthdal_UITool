...
class CUI_QuestMarkerDeco final : public CUI
{
public:

private:
	CUI_QuestMarkerDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestMarkerDeco(const CUI_QuestMarkerDeco& Prototype);
	virtual ~CUI_QuestMarkerDeco() = default;
...
public:
	static CUI_QuestMarkerDeco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
