...
class CUI_SubQuestPanel final : public CUI
{
public:

private:
	CUI_SubQuestPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SubQuestPanel(const CUI_SubQuestPanel& Prototype);
	virtual ~CUI_SubQuestPanel() = default;
...
public:
	static CUI_SubQuestPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
