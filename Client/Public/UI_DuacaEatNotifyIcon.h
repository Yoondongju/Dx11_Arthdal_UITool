...
class CUI_DuacaEatNotifyIcon final : public CUI
{
public:


private:
	CUI_DuacaEatNotifyIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_DuacaEatNotifyIcon(const CUI_DuacaEatNotifyIcon& Prototype);
	virtual ~CUI_DuacaEatNotifyIcon() = default;
...
public:
	static CUI_DuacaEatNotifyIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
