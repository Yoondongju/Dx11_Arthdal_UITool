...
class CUI_QuickSlotHelperSecond final : public CUI
{
public:

private:
	CUI_QuickSlotHelperSecond(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuickSlotHelperSecond(const CUI_QuickSlotHelperSecond& Prototype);
	virtual ~CUI_QuickSlotHelperSecond() = default;
...
public:
	static CUI_QuickSlotHelperSecond* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
