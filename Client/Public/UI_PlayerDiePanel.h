...
class CUI_PlayerDiePanel final : public CUI
{
private:
    CUI_PlayerDiePanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_PlayerDiePanel(const CUI_PlayerDiePanel& Prototype);
    virtual ~CUI_PlayerDiePanel() = default;
...
public:
    static CUI_PlayerDiePanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
