...
class CUI_DuacaHpPanel final : public CUI
{
public:


private:
	CUI_DuacaHpPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_DuacaHpPanel(const CUI_DuacaHpPanel& Prototype);
	virtual ~CUI_DuacaHpPanel() = default;
...
public:
	static CUI_DuacaHpPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
