...
class CUI_PlayerPanelHpMp final : public CUI
{
public:

private:
	CUI_PlayerPanelHpMp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_PlayerPanelHpMp(const CUI_PlayerPanelHpMp& Prototype);
	virtual ~CUI_PlayerPanelHpMp() = default;
...
public:
	static CUI_PlayerPanelHpMp* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
