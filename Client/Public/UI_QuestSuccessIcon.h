#pragma once
class CUI_QuestSuccessIconPanel
{
};
...
class CUI_QuestSuccessIcon final : public CUI
{
public:

private:
	CUI_QuestSuccessIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestSuccessIcon(const CUI_QuestSuccessIcon& Prototype);
	virtual ~CUI_QuestSuccessIcon() = default;
...
public:
	static CUI_QuestSuccessIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
