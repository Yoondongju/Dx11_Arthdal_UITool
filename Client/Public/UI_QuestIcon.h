...
private:
	CUI_QuestIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestIcon(const CUI_QuestIcon& Prototype);
...
public:
	static CUI_QuestIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
