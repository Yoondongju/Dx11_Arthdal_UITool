...
class CUI_KeyPad final : public CUI
{
public:


private:
	CUI_KeyPad(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_KeyPad(const CUI_KeyPad& Prototype);
	virtual ~CUI_KeyPad() = default;
...
public:
	static CUI_KeyPad* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
