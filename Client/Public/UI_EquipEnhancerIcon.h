...
class CUI_EquipEnhancerIcon final : public CUI
{
private:
    CUI_EquipEnhancerIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_EquipEnhancerIcon(const CUI_EquipEnhancerIcon& Prototype);
    virtual ~CUI_EquipEnhancerIcon() = default;
...
public:
    static CUI_EquipEnhancerIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
