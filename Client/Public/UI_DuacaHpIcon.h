...
class CUI_DuacaHpIcon final : public CUI
{
public:


private:
	CUI_DuacaHpIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_DuacaHpIcon(const CUI_DuacaHpIcon& Prototype);
	virtual ~CUI_DuacaHpIcon() = default;
...
public:
	static CUI_DuacaHpIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
