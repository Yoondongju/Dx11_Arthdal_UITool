...
class CUI_MainMenuIcon final : public CUI
{
public:

private:
	CUI_MainMenuIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_MainMenuIcon(const CUI_MainMenuIcon& Prototype);
	virtual ~CUI_MainMenuIcon() = default;
...
public:
	static CUI_MainMenuIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
