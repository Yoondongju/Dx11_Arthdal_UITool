...
class CUI_QuestPanel final : public CUI
{
public:

private:
	CUI_QuestPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuestPanel(const CUI_QuestPanel& Prototype);
	virtual ~CUI_QuestPanel() = default;
...
public:
	static CUI_QuestPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
