...
class CUI_TalkInteract final : public CUI
{
public:


private:
	CUI_TalkInteract(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_TalkInteract(const CUI_TalkInteract& Prototype);
	virtual ~CUI_TalkInteract() = default;
...
public:
	static CUI_TalkInteract* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
