...
class CUI_InventoryPanel final : public CUI
{
public:

private:
	CUI_InventoryPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_InventoryPanel(const CUI_InventoryPanel& Prototype);
	virtual ~CUI_InventoryPanel() = default;
...
public:
	static CUI_InventoryPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
