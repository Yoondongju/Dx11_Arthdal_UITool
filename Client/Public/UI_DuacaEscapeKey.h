...
class CUI_DuacaEscapeKey final : public CUI
{
public:


private:
	CUI_DuacaEscapeKey(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_DuacaEscapeKey(const CUI_DuacaEscapeKey& Prototype);
	virtual ~CUI_DuacaEscapeKey() = default;
...
public:
	static CUI_DuacaEscapeKey* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
