...
class CUI_SkillCoolNotifyPanel final : public CUI
{
public:


private:
	CUI_SkillCoolNotifyPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SkillCoolNotifyPanel(const CUI_SkillCoolNotifyPanel& Prototype);
	virtual ~CUI_SkillCoolNotifyPanel() = default;
...
public:
	static CUI_SkillCoolNotifyPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
