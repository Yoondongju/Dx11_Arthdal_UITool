...
class CUI_ItemInfoPanel final : public CUI
{
public:

private:
	CUI_ItemInfoPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_ItemInfoPanel(const CUI_ItemInfoPanel& Prototype);
	virtual ~CUI_ItemInfoPanel() = default;
...
public:
	static CUI_ItemInfoPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
