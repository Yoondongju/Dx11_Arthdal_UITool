...
class CUI_RegionEntryDeco final : public CUI
{
public:


private:
	CUI_RegionEntryDeco(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_RegionEntryDeco(const CUI_RegionEntryDeco& Prototype);
	virtual ~CUI_RegionEntryDeco() = default;
...
public:
	static CUI_RegionEntryDeco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
