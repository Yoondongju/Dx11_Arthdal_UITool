...
class CUI_QuickSlotHelperFirst final : public CUI
{
public:

private:
	CUI_QuickSlotHelperFirst(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_QuickSlotHelperFirst(const CUI_QuickSlotHelperFirst& Prototype);
	virtual ~CUI_QuickSlotHelperFirst() = default;
...
public:
	static CUI_QuickSlotHelperFirst* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
