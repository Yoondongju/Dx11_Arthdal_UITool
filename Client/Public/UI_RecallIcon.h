...
class CUI_RecallIcon final : public CUI
{
public:

private:
	CUI_RecallIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_RecallIcon(const CUI_RecallIcon& Prototype);
	virtual ~CUI_RecallIcon() = default;
...
public:
	static CUI_RecallIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
