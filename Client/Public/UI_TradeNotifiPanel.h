...
class CUI_TradeNotifiPanel final : public CUI
{
private:
    CUI_TradeNotifiPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_TradeNotifiPanel(const CUI_TradeNotifiPanel& Prototype);
    virtual ~CUI_TradeNotifiPanel() = default;
...
public:
    static CUI_TradeNotifiPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
