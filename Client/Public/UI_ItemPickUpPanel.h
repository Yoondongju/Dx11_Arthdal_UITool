...
class CUI_ItemPickUpPanel final : public CUI
{
private:
	CUI_ItemPickUpPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_ItemPickUpPanel(const CUI_ItemPickUpPanel& Prototype);
	virtual ~CUI_ItemPickUpPanel() = default;
...
public:
	static CUI_ItemPickUpPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
