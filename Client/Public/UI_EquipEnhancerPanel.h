...
class CUI_EquipEnhancerPanel final : public CUI
{
private:
    CUI_EquipEnhancerPanel(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_EquipEnhancerPanel(const CUI_EquipEnhancerPanel& Prototype);
    virtual ~CUI_EquipEnhancerPanel() = default;
...
public:
    static CUI_EquipEnhancerPanel* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
