...
class CUI_PotionMenuIcon final : public CUI
{
private:
    CUI_PotionMenuIcon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_PotionMenuIcon(const CUI_PotionMenuIcon& Prototype);
    virtual ~CUI_PotionMenuIcon() = default;
...
public:
    static CUI_PotionMenuIcon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
