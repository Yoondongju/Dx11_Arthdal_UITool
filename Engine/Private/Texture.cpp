...
CTexture::CTexture(const CTexture & Prototype)
	...
	, m_LStrMyPath {Prototype.m_LStrMyPath}
{
...
CTexture * CTexture::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, const _tchar * pTextureFilePath, _uint iNumTextures, CTexture** pOut)
{
